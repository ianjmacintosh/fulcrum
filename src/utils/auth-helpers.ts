 ...
 */
export function requireAdminAuth(request: Request): { adminId: string } | { response: Response } {
 ...
 */
export function requireUserAuth(request: Request): { userId: string } | { response: Response } {
 ...
 */
export function requireAuth(request: Request): { session: { userId: string; userType: 'admin' | 'user' } } | { response: Response } {
 ...
 */
export async function authenticateAdmin(username: string, password: string): Promise<{ success: true; adminId: string } | { success: false; error: string }> {
  try {
 ...
 */
export async function authenticateUser(email: string, password: string): Promise<{ success: true; userId: string } | { success: false; error: string }> {
  try {
 ...
 */
export async function authenticate(identifier: string, password: string): Promise<
