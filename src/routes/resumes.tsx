    ...
    return (
        <div className="page">
            <header className="page-header">
                <h1>Resumes</h1>
                <p>Track different resume versions, time spent, and their performance</p>
            </header>
            ...
            <main className="page-content">
                <section className="resumes-list">
                    <div className="resume-card featured">
                        ...
                        <div className="resume-actions">
                            <button type="button" className="action-button">View</button>
                            <button type="button" className="action-button">Edit</button>
                            <button type="button" className="action-button">Download</button>
                        </div>
                    </div>
                ...
                <section className="resume-insights">
                    ...
                    <div className="insight-card">
                        ...
                        <p>Resumes mentioning "React", "TypeScript", and "AWS" have 23% higher response rates.</p>
                    </div>
                    <div className="insight-card">
                        <h4>Time Investment Analysis</h4>
                        <p>Spending more than 6 hours on resume optimization correlates with better performance.</p>
                    </div>
                </section>
