      ...
      <main className="page-content">
        ...
        <section className="settings-section">
          ...
          <div className="setting-description">
            <p>
              This information will be used by the browser extension to
        ...
        <section className="settings-section">
          ...
          <div className="email-integration">
            ...
            <div className="setting-description">
              <p>
                Forward job-related emails to this address to automatically
                update application status instead of manual entry.
              </p>
            </div>
            <div className="setting-item">
